    ...
    return (
        <div className='container'>
            ...
            <section className='Section_3'>
                ...
                <div className="Section_3_Box">ক্যাশ ডিপোজিট</div>
                <div className="Section_3_Box">নগদ টাকা উত্তোলন</div>
                <div className="Section_3_Box">নগদ টাকা স্থানান্তর</div>
                <div className="Section_3_Box">অভ্যন্তরীণ প্রেরিত অর্থ</div>
                <div className="Section_3_Box">ইউটিলিটি বিল পেমেন্ট</div>
                <div className="Section_3_Box">ইউটিলিটি বিল পেমেন্ট</div>
                <div className="Section_3_Box">ব্যালেন্স ইনকয়েরি</div>
                <div className="Section_3_Box">অ্যাকাউন্ট বিবৃতি (ক্ষুদ্র)</div>
                <div className="Section_3_Box">বীমা প্রিমিয়াম সংগ্রহ</div>
                <div className="Section_3_Box">এসএমই ঋণ প্রক্রিয়াকরণ</div>
                <div className="Section_3_Box">কৃষি ঋণ প্রক্রিয়াকরণ</div>
                <div className="Section_3_Box">ডেবিট / ক্রেডিট কার্ড কাগজ প্রক্রিয়াকরণ</div>
